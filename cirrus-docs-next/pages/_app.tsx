    ...
    return (
        <Store>
            <Head>
                ...
                <link rel="apple-touch-icon" sizes="57x57" href="https://cirrus-ui.com/apple-icon-57x57.png" />
                <link rel="apple-touch-icon" sizes="60x60" href="https://cirrus-ui.com/apple-icon-60x60.png" />
                <link rel="apple-touch-icon" sizes="72x72" href="https://cirrus-ui.com/apple-icon-72x72.png" />
                <link rel="apple-touch-icon" sizes="76x76" href="https://cirrus-ui.com/apple-icon-76x76.png" />
                <link
                    rel="apple-touch-icon"
                    sizes="114x114"
                    href="https://cirrus-ui.com/apple-icon-114x114.png"
                />
                <link
                    rel="apple-touch-icon"
                    sizes="120x120"
                    href="https://cirrus-ui.com/apple-icon-120x120.png"
                />
                <link
                    rel="apple-touch-icon"
                    sizes="144x144"
                    href="https://cirrus-ui.com/apple-icon-144x144.png"
                />
                <link
                    rel="apple-touch-icon"
                    sizes="152x152"
                    href="https://cirrus-ui.com/apple-icon-152x152.png"
                />
                <link
                    rel="apple-touch-icon"
                    sizes="180x180"
                    href="https://cirrus-ui.com/apple-icon-180x180.png"
                />
                <link
                    rel="apple-touch-icon"
                    sizes="192x192"
                    href="https://cirrus-ui.com/android-icon-192x192.png"
                />
                <link rel="icon" type="image/png" href="/favicon.ico" />
                <meta name="msapplication-TileColor" content="#f03d4d" />
                <meta name="msapplication-TileImage" content="https://cirrus-ui.com/ms-icon-70x70.png" />
                <meta name="msapplication-TileImage" content="https://cirrus-ui.com/ms-icon-144x144.png" />
                <meta name="msapplication-TileImage" content="https://cirrus-ui.com/ms-icon-150x150.png" />
                <meta name="msapplication-TileImage" content="https://cirrus-ui.com/ms-icon-310x310.png" />
