...
export const TypographyPage: React.FC<any> = (props) => {
    return (
        <main className="page-layout typography-page">
            <Head>
                <title>{PAGE_TITLE_PREFIX} Typography</title>
            </Head>
            <div>
                ...
                <section className="padtop" id="typefaces">
                    <div className="content">
                        ...
                        <p>This is our alternative/secondary font. This can be set as the font for a given element with the <code>font-secondary</code> class.</p>
                        <div className="frame mb-2">
                            <div className="frame__header"></div>
                            <div className="frame__body">
...
export default withLayout(<DefaultLayout />)(TypographyPage);
