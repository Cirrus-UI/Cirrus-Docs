                    ...
                    <div className="content">
                        ...
                        <div className="row">
                            <div className="md:col-6">
                                <CodeBlock
                                    code={`$default-config: (
    // Configure which pseudos to support for each class (e.g. responsive, hover, first-child)
    pseudo-variants: (),
    ...
    ...
                            ...
                            <div className="md:col-6">
                                <ul className="no-bullets">
                                    <li>
                                        <details open>
                                            <summary className="font-bold">Pseudo-Variants</summary>
                                            <p>
                                                Configure which pseudo-variants to generate for different classes. For example, the <code>responsive</code> pseudo-variant helps generate <code>sm:</code>, <code>md:</code>, <code>lg:</code>, and <code>xl:</code> classes.
                                            </p>
                                        </details>
                                    </li>
                                    <li>
    ...
    .my-class {
        background-color: rgba(#{hex-to-rgb(fill('blue', '600'))}, .25);
                ...
                <section className="padtop" id="pseudo-variants">
                    <div className="content">
                        <Headline title="Pseudo-Variants" size="4" link="#pseudo-variants" />
                        <div className="divider"></div>
                        <p>
                        ...
                        <p>
                            For instance, if I enable the <code>responsive</code> and <code>hover</code> pseudo-variants for flexbox classes, then every flexbox associated
                            utility class will also have viewport variant and hover classes as well.
                        </p>
...
@media screen and (min-width: 640px) {
    .sm:u-flex-column { ... }
    .hover:sm:u-flex-column { ... }
}
@media screen and (min-width: 768px) {
    .md:u-flex-column { ... }
    .hover:md:u-flex-column { ... }
}
...`}
                            language="css"
                        />
